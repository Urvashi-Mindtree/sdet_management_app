class TraineesController < ApplicationController
  ...
  def new
    @trainee = Trainee.new
    @trainee.course_id = params[:param1]
	@trainee.start_date= params[:start_date]
	@trainee.end_date= params[:end_date]
  end
  ...
  private
    ...
    def trainee_params
     params.require(:trainee).permit(:trainee_name, :course_id, :status, :assign_date, :trainee_email,:end_date,:start_date)
    end
